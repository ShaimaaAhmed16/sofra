...
<div class="container">
    ...
    <section class=" register-page py-5 my-5">
        ...
        <div class="reg mx-auto my-5">
            ...
            <form action="{{url('login-client')}}" class="p-5 my-3 text-center" method="post">
                @csrf
                ...
                <div class="form-row my-3">
                    <div class="col pass" style="margin-left: 40%">
                        <a href="">نسيت كلمة السر ؟</a>
                    </div>
                </div>
                <a class="btn w-75 my-4 text-white" href="{{url('register-client')}}" style="background:#A10A4A">انشيء حساب الآن</a>
            </form>
        </div>
    </section>
</div>
