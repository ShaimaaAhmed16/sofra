    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">List of region</h3>
                            ...
                            <tbody>
                                @foreach($records as $record)
                                    <tr>
                                        ...
                                        <th>{{$record->name}}</th>
                                       <th>{{optional($record->city)->name}}</th>
                                        <th>
                                            <a href="{{url(route('region.edit',$record->id))}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
                                        </th >
                                        <th>
