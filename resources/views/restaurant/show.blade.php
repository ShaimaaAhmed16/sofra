    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                {!!  Form::open(['action'=>['RestauranrController@show',$record->id],'method'=>'put']) !!}
                <div class="row ">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <p class="m-0">{{$record->delivery_charge}}</p>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item list-group-item-action">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <p class="m-0">{{$record->opened_at}}</p>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item list-group-item-action">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <p class="m-0">{{$record->closed_at}}</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
